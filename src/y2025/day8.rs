...
const FIRST_EXAMPLE: &str =  "162,817,812\n57,618,57\n906,360,560\n592,479,940\n352,342,300\n466,668,158\n542,29,236\n431,825,988\n739,650,466\n52,470,668\n216,146,977\n819,987,18\n117,168,530\n805,96,715\n346,949,466\n970,615,88\n941,993,340\n862,61,35\n984,92,344\n425,690,689";
...
pub fn day_8_1(args: &yt::SolverArgs) -> yt::Result<aoc::Answer> {
    ...
    // 1000.
    let iteration_count = if args.input == FIRST_EXAMPLE {
        10
    } else {
        1000
    };
    ...
    Ok(uf
        .sets()
        .iter()
        .inspect(|s| eprintln!("{} is size {}", s.0, s.1))
        .take(3)
        .map(|(_set, size)| size)
        .product::<usize>()
        .into())
...
pub fn day_8_2(_args: &yt::SolverArgs) -> yt::Result<aoc::Answer> {
...
mod tests {
    ...
    fn find_closest_pairs_using_example() {
        let positions = parse_junction_box_positions(&FIRST_EXAMPLE);
        let pairs = find_pairs_closest(&positions)
            .into_iter()
            .map(|(_dist, a, b)| (a, b))
            .collect::<Vec<_>>();
